...
Namespace PermissionPolicyExample.Win
    Partial Public Class PermissionPolicyExampleWindowsFormsApplication
        ...
        End Sub
        Private Sub PermissionPolicyExampleWindowsFormsApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs) Handles Me.DatabaseVersionMismatch
        ...
        End Sub
        Private Sub PermissionPolicyExampleWindowsFormsApplication_CustomizeLanguagesList(ByVal sender As Object, ByVal e As CustomizeLanguagesListEventArgs) Handles Me.CustomizeLanguagesList
