...
#End If
        ...
        Protected Sub Session_Start(ByVal sender As Object, ByVal e As EventArgs)
            ...
            AddHandler WebApplication.Instance.CreateCustomObjectSpaceProvider, Sub(sender2 As Object, e2 As CreateCustomObjectSpaceProviderEventArgs)
        ...
        Protected Sub Session_End(ByVal sender As Object, ByVal e As EventArgs)
            ...
            Dim clientDataServer As WcfSecuredDataServerClient = DirectCast(Session("DataServerClient"), WcfSecuredDataServerClient)
