...
#End If
		...
		Protected Sub Session_Start(ByVal sender As Object, ByVal e As EventArgs)
			...
			AddHandler WebApplication.Instance.CreateCustomObjectSpaceProvider, Function(sender2, e2) AnonymousMethod1(sender2, e2, clientDataServer, securityClient)
			WebApplication.Instance.Setup()
			WebApplication.Instance.Start()
		End Sub
		
		Private Function AnonymousMethod1(ByVal sender2 As Object, ByVal e2 As CreateCustomObjectSpaceProviderEventArgs, ByVal clientDataServer As WcfSecuredDataServerClient, ByVal securityClient As ServerSecurityClient) As Boolean
